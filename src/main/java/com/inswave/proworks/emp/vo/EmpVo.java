...
@ElDto(FldYn = "Y", delimeterYn = "", logicalName = "デモ従業員情報")
public class EmpVo extends com.inswave.proworks.cmmn.ProworksCommVO {
    ...
    @ElDtoField(logicalName = "従業員番号", physicalName = "empno", type = "int", typeKind = "", fldYn = "Yes", delimeterYn = "Yes", cryptoGbn = "", cryptoKind = "", length = 4, dotLen = 0, baseValue = "", desc = "従業員番号の説明")
    private int empno;

    @ElDtoField(logicalName = "従業員名", physicalName = "ename", type = "String", typeKind = "", fldYn = "Yes", delimeterYn = "Yes", cryptoGbn = "", cryptoKind = "", length = 10, dotLen = 0, baseValue = "", desc = "")
    private String ename;

    @ElDtoField(logicalName = "職種", physicalName = "job", type = "String", typeKind = "", fldYn = "Yes", delimeterYn = "Yes", cryptoGbn = "", cryptoKind = "", length = 9, dotLen = 0, baseValue = "", desc = "")
    private String job;

    @ElDtoField(logicalName = "直属上司番号", physicalName = "mgr", type = "int", typeKind = "", fldYn = "Yes", delimeterYn = "Yes", cryptoGbn = "", cryptoKind = "", length = 4, dotLen = 0, baseValue = "", desc = "")
    private int mgr;

    @ElDtoField(logicalName = "入社日", physicalName = "hiredate", type = "String", typeKind = "", fldYn = "Yes", delimeterYn = "Yes", cryptoGbn = "", cryptoKind = "", length = 10, dotLen = 0, baseValue = "", desc = "")
    private String hiredate;

    @ElDtoField(logicalName = "給与", physicalName = "sal", type = "double", typeKind = "", fldYn = "Yes", delimeterYn = "Yes", cryptoGbn = "", cryptoKind = "", length = 7, dotLen = 2, baseValue = "", desc = "")
    private double sal;

    @ElDtoField(logicalName = "手当", physicalName = "comm", type = "double", typeKind = "", fldYn = "Yes", delimeterYn = "Yes", cryptoGbn = "", cryptoKind = "", length = 7, dotLen = 2, baseValue = "", desc = "")
    private double comm;

    @ElDtoField(logicalName = "部門番号", physicalName = "deptno", type = "String", typeKind = "", fldYn = "Yes", delimeterYn = "Yes", cryptoGbn = "", cryptoKind = "", length = 2, dotLen = 0, baseValue = "", desc = "")
    private String deptno;

    @ElDtoField(logicalName = "部門名", physicalName = "dname", type = "String", typeKind = "", fldYn = "Yes", delimeterYn = "Yes", cryptoGbn = "", cryptoKind = "", length = 14, dotLen = 0, baseValue = "", desc = "")
    private String dname;

    @ElDtoField(logicalName = "直属上司名", physicalName = "mgrname", type = "String", typeKind = "", fldYn = "No", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String mgrname;

    @ElDtoField(logicalName = "従業員説明", physicalName = "account", type = "String", typeKind = "", fldYn = "No", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String account;

    @ElDtoField(logicalName = "列ステータス", physicalName = "rowStatus", type = "String", typeKind = "", fldYn = "No", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String rowStatus;

    @ElDtoField(logicalName = "検索_従業員番号", physicalName = "scEmpno", type = "String", typeKind = "", fldYn = "No", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String scEmpno;

    @ElDtoField(logicalName = "検索_従業員名", physicalName = "scEname", type = "String", typeKind = "", fldYn = "No", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String scEname;

    @ElDtoField(logicalName = "検索_職種", physicalName = "scJob", type = "String", typeKind = "", fldYn = "No", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String scJob;

    @ElDtoField(logicalName = "検索_部署コード", physicalName = "scDeptno", type = "String", typeKind = "", fldYn = "No", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String scDeptno;

    @ElDtoField(logicalName = "検索_部署名", physicalName = "scDname", type = "String", typeKind = "", fldYn = "No", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String scDname;

    @ElDtoField(logicalName = "ファイル名", physicalName = "fileName", type = "String", typeKind = "", fldYn = "No", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String fileName;

    @ElDtoField(logicalName = "ファイルデータ", physicalName = "fileData", type = "byte[]", typeKind = "", fldYn = "No", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private byte[] fileData;

    @ElDtoField(logicalName = "マルチパートファイル", physicalName = "inputFileData", type = "MultipartFile", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
