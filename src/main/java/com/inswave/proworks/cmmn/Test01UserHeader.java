...
@ElDto(FldYn = "Y", delimeterYn = "", logicalName = "テスト01ユーザーヘッダー")
public class Test01UserHeader extends com.inswave.elfw.core.UserHeader {
    ...
    @ElDtoField(logicalName = "社員番号", physicalName = "empno", type = "int", typeKind = "", fldYn = "Yes", delimeterYn = "Yes", cryptoGbn = "", cryptoKind = "", length = 4, dotLen = 0, baseValue = "", desc = "社員番号の説明")
    private int empno;

    @ElDtoField(logicalName = "社員名", physicalName = "ename", type = "String", typeKind = "", fldYn = "Yes", delimeterYn = "Yes", cryptoGbn = "", cryptoKind = "", length = 10, dotLen = 0, baseValue = "", desc = "")
    private String ename;

    @ElDtoField(logicalName = "職業", physicalName = "job", type = "String", typeKind = "", fldYn = "Yes", delimeterYn = "Yes", cryptoGbn = "", cryptoKind = "", length = 9, dotLen = 0, baseValue = "", desc = "")
    private String job;
