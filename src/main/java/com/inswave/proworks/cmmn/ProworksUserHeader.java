...
@ElDto(FldYn = "Y", delimeterYn = "", logicalName = "ヘッダーVO")
public class ProworksUserHeader extends com.inswave.elfw.core.UserHeader {
    ...
    @ElDtoField(logicalName = "メッセージ長", physicalName = "fldLen", type = "int", typeKind = "", fldYn = "Yes", delimeterYn = "Yes", cryptoGbn = "", cryptoKind = "", length = 10, dotLen = 0, baseValue = "", desc = "")
    private int fldLen;

    @ElDtoField(logicalName = "サービスID", physicalName = "svcId", type = "String", typeKind = "", fldYn = "Yes", delimeterYn = "Yes", cryptoGbn = "", cryptoKind = "", length = 20, dotLen = 0, baseValue = "", desc = "")
    private String svcId;

    @ElDtoField(logicalName = "メッセージ入力ID", physicalName = "inInfId", type = "String", typeKind = "", fldYn = "Yes", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 30, dotLen = 0, baseValue = "", desc = "")
    private String inInfId;

    @ElDtoField(logicalName = "メッセージ出力ID", physicalName = "outInfId", type = "String", typeKind = "", fldYn = "Yes", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 30, dotLen = 0, baseValue = "", desc = "")
    private String outInfId;

    @ElDtoField(logicalName = "成功失敗フラグ", physicalName = "sucYn", type = "String", typeKind = "", fldYn = "Yes", delimeterYn = "Yes", cryptoGbn = "", cryptoKind = "", length = 1, dotLen = 0, baseValue = "", desc = "")
    private String sucYn;

    @ElDtoField(logicalName = "エラーコード", physicalName = "errorCode", type = "String", typeKind = "", fldYn = "Yes", delimeterYn = "Yes", cryptoGbn = "", cryptoKind = "", length = 30, dotLen = 0, baseValue = "", desc = "")
    private String errorCode;

    @ElDtoField(logicalName = "エラーメッセージ", physicalName = "errMag", type = "String", typeKind = "", fldYn = "Yes", delimeterYn = "Yes", cryptoGbn = "", cryptoKind = "", length = 100, dotLen = 0, baseValue = "", desc = "")
    private String errMag;

    @ElDtoField(logicalName = "テスト", physicalName = "location", type = "String", typeKind = "", fldYn = "Yes", delimeterYn = "Yes", cryptoGbn = "", cryptoKind = "", length = 10, dotLen = 0, baseValue = "", desc = "")
    private String location;

    @ElDtoField(logicalName = "ユーザーID", physicalName = "testId", type = "String", typeKind = "", fldYn = "Yes", delimeterYn = "Yes", cryptoGbn = "", cryptoKind = "", length = 10, dotLen = 0, baseValue = "", desc = "")
    private String testId;

    @ElDtoField(logicalName = "テスト01カウント", physicalName = "test01Cnt", type = "String", typeKind = "", fldYn = "No", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 11, dotLen = 0, baseValue = "", desc = "")
    private String test01Cnt;

    @ElDtoField(logicalName = "テスト01ユーザーヘッダー", physicalName = "test01UserHeader", type = "", typeKind = "List", fldYn = "No", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "test01Cnt", desc = "")
    private java.util.List<com.inswave.proworks.cmmn.Test01UserHeader> test01UserHeader;

    @ElDtoField(logicalName = "テスト ユーザーヘッダー 02", physicalName = "test02UserHeader", type = "", typeKind = "List", fldYn = "No", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private java.util.List<com.inswave.proworks.cmmn.Test02UserHeader> test02UserHeader;

    @ElDtoField(logicalName = "ユーザー名", physicalName = "testUserName", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String testUserName;
@ElDtoField(logicalName = "部署名", physicalName = "testDeptName", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String testDeptName;

    @ElDtoField(logicalName = "部署コード", physicalName = "testDeptNo", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    ...
    public java.util.List<com.inswave.proworks.cmmn.Test01UserHeader> getTest01UserHeader(){
        return test01UserHeader;
    }

    public void setTest01UserHeader(java.util.List<com.inswave.proworks.cmmn.Test01UserHeader> test01UserHeader){
        this.test01UserHeader = test01UserHeader;
    }

    public java.util.List<com.inswave.proworks.cmmn.Test02UserHeader> getTest02UserHeader(){
        return test02UserHeader;
    }

    public void setTest02UserHeader(java.util.List<com.inswave.proworks.cmmn.Test02UserHeader> test02UserHeader){
    ...
    public void _xStreamEnc() {
        for (int i = 0; test01UserHeader != null && i < test01UserHeader.size(); i++) {
            com.inswave.proworks.cmmn.Test01UserHeader vo = (com.inswave.proworks.cmmn.Test01UserHeader)test01UserHeader.get(i);
            vo._xStreamEnc();
        }
        for (int i = 0; test02UserHeader != null && i < test02UserHeader.size(); i++) {
            com.inswave.proworks.cmmn.Test02UserHeader vo = (com.inswave.proworks.cmmn.Test02UserHeader)test02UserHeader.get(i);
            vo._xStreamEnc();
        }
    }
